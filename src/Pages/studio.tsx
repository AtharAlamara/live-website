...
function StudioPage() {
  ...
  useEffect(() => {
    const obs = new IntersectionObserver(([e]) => setIsButtonVisible(e.isIntersecting), {
      threshold: 0.1,
    });
    ...
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={t(
            '{seo-studio-description}',
            'Founded in 2020, Athar Alamara is a multi-talented architecture and design studio based in Riyadh, Saudi Arabia. LEED certified architects and interior designers.'
          )}
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content={t(
            '{seo-studio-og-description}',
            'Founded in 2020, Athar Alamara is a multi-talented architecture and design studio based in Riyadh, Saudi Arabia'
          )}
        />
        ...
        <meta
          ...
          content={t(
            '{seo-studio-twitter-description}',
            'Founded in 2020, Athar Alamara is a multi-talented architecture and design studio based in Riyadh, Saudi Arabia'
          )}
        />
