  ...
  return (
    <ServiceTemplate
      ...
      fallbackAr={{
        ...
        p2: `نعمل عن قرب مع عملائنا في جميع مراحل المشروع، من تطوير الفكرة والحصول على الموافقات، إلى إعداد المخططات التنفيذية والإشراف في الموقع، بما يضمن تنفيذ التصميم بأعلى جودة وتحقيق أفضل نتيجة ممكنة. سواء كنت تخطط لبناء منزل جديد أو تطوير مشروع تجاري، فإن فريقنا ملتزم بتقديم حلول مدروسة ومبتكرة، مصممة بعناية لتتناسب مع أهدافك. نؤمن بأن كل مشروع يحمل فرصة لإعادة تعريف العلاقة بين الإنسان والمكان، مما يدفعنا إلى ابتكار تصاميم تعبّر عن روح البيئة التي تنشأ فيها، وتواكب في الوقت ذاته أنماط الحياة المتجددة والحديثة`,
