...
function PrivacyPage() {
  ...
  // ✅ EXACT SAME bullet style logic as Terms page:
  // - Force non-bold in Arabic (fontWeight + opacity)
  // - Keep consistent weight in English by explicitly setting fontWeight too
  const liStyle = isAr ? { fontWeight: 200 as const, opacity: 0.85 } : { fontWeight: 200 as const };
      ...
      <Helmet>
        ...
        <meta
          ...
          content={t(
            ...
            'Privacy Policy for Athar Alamara. How we collect, use, and protect your personal data.'
          )}
        />
        <meta
          name="keywords"
          content={t(
            ...
            'privacy policy, data protection, personal data, Athar Alamara privacy'
          )}
        />
        <meta property="og:title" content={t('{seo-privacy-og-title}', 'Privacy Policy | Athar Alamara')} />
        <meta
          property="og:description"
          content={t('{seo-privacy-og-description}', 'Privacy Policy for Athar Alamara website and services')}
        />
        ...
        <meta
          ...
          content={t('{seo-privacy-twitter-description}', 'Privacy Policy for Athar Alamara website and services')}
        />
            ...
            {!loading && (
              <div className="prose prose-lg max-w-xl space-y-8" style={{ direction: isAr ? 'rtl' : 'ltr' }}>
                ...
                >
                  {t(
                    '{intro}',
                    'At Athar Architecture, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website, in compliance with Saudi Arabian data protection regulations.'
                  )}
                </p>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{info-li1}', 'Personal Information: Name, email address, phone number, and other details you provide voluntarily through contact forms or communications.')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{info-li2}', 'Usage Data: Information about how you use our website, including pages visited, time spent, and interactions, collected through Google Analytics.')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{info-li3}', 'Technical Data: IP address, browser type, device information, and cookies.')}
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{use-li1}', 'Respond to your inquiries and provide customer support')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{use-li2}', 'Analyze website traffic and user behavior to improve our services')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{use-li3}', 'Ensure the security and functionality of our website')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{use-li4}', 'Comply with legal obligations under Saudi Arabian law')}</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-2 space-y-1`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{ga-li1}', 'Using our cookie preferences to disable analytics')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{ga-li2}', 'Installing the Google Analytics opt-out browser add-on')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{ga-li3}', 'Adjusting your browser settings to block cookies')}</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{cookies-li1}', 'Remember your cookie preferences')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{cookies-li2}', 'Analyze website usage through Google Analytics')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{cookies-li3}', 'Ensure proper website functionality')}</li>
                  </ul>
                  <p className="mt-4 text-lg leading-relaxed font-thin text-[#000000]" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{share-li1}', 'Google Analytics (anonymized usage data only)')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{share-li2}', 'Trusted service providers who assist in website operations under strict confidentiality agreements')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{share-li3}', 'Legal authorities when required by Saudi Arabian law')}</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{rights-li1}', 'Access your personal information')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{rights-li2}', 'Correct inaccurate data')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{rights-li3}', 'Request deletion of your data')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{rights-li4}', 'Object to data processing')}</li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>{t('{rights-li5}', 'Withdraw consent for analytics cookies')}</li>
                  </ul>
                  <p className="mt-4 text-lg leading-relaxed font-thin text-[#000000]" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
