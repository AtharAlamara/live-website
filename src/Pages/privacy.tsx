...
function PrivacyPage() {
  ...
  // ✅ Windows detection (for Windows+English bullet consistency only)
  const isWindows =
  ...
  // ✅ Bullet style:
  // - Arabic: force NOT bold
  // - Windows+English: make them consistent (thinner feel) without touching Mac+English
  // - Mac+English: no change
  const liStyle = isAr
    ? ({ fontWeight: 200 } as React.CSSProperties)
    : isWinEn
    ? ({ fontWeight: 200, opacity: 0.85 } as React.CSSProperties)
    : undefined;
  ...
  return (
    <PageWrapper>
      <Helmet>
        ...
        <meta
          property="og:title"
          content={t('{seo-privacy-og-title}', 'Privacy Policy | Athar Alamara')}
        />
        <meta
          property="og:description"
          content={t(
            '{seo-privacy-og-description}',
            'Privacy Policy for Athar Alamara website and services'
          )}
        />
        ...
        <meta
          name="twitter:title"
          content={t('{seo-privacy-twitter-title}', 'Privacy Policy | Athar Alamara')}
        />
        <meta
          name="twitter:description"
          content={t(
            '{seo-privacy-twitter-description}',
            'Privacy Policy for Athar Alamara website and services'
          )}
        />
              ...
              <div className="prose prose-lg max-w-xl space-y-8" style={{ direction: isAr ? 'rtl' : 'ltr' }}>
                ...
                <section>
                  <h2
                    ...
                    style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", color: '#000000' }}
                  >
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t(
                        '{info-li1}',
                        'Personal Information: Name, email address, phone number, and other details you provide voluntarily through contact forms or communications.'
                      )}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t(
                        '{info-li2}',
                        'Usage Data: Information about how you use our website, including pages visited, time spent, and interactions, collected through Google Analytics.'
                      )}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{use-li1}', 'Respond to your inquiries and provide customer support')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{use-li2}', 'Analyze website traffic and user behavior to improve our services')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{use-li3}', 'Ensure the security and functionality of our website')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{use-li4}', 'Comply with legal obligations under Saudi Arabian law')}
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  >
                    {t(
                      '{ga-p1}',
                      'We use Google Analytics to understand how visitors interact with our website. Google Analytics collects information anonymously and reports website trends without identifying individual visitors. This service may use cookies to track your usage patterns.'
                    )}
                  </p>
                  <p
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-2 space-y-1`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{ga-li1}', 'Using our cookie preferences to disable analytics')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{ga-li2}', 'Installing the Google Analytics opt-out browser add-on')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{ga-li3}', 'Adjusting your browser settings to block cookies')}
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  >
                    {t(
                      '{cookies-p1}',
                      'We use cookies to enhance your browsing experience and analyze website performance. Cookies are small text files stored on your device that help us:'
                    )}
                  </p>
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{cookies-li1}', 'Remember your cookie preferences')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{cookies-li2}', 'Analyze website usage through Google Analytics')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{cookies-li3}', 'Ensure proper website functionality')}
                    </li>
                  </ul>
                  <p
                    className="mt-4 text-lg leading-relaxed font-thin text-[#000000]"
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{share-li1}', 'Google Analytics (anonymized usage data only)')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{share-li2}', 'Trusted service providers who assist in website operations under strict confidentiality agreements')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{share-li3}', 'Legal authorities when required by Saudi Arabian law')}
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  >
                    {t(
                      '{security-p1}',
                      'We implement appropriate technical and organizational measures to protect your information from unauthorized access, use, or disclosure, in accordance with Saudi Arabian data protection standards.'
                    )}
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className={`list-disc ${isAr ? 'pr-6' : 'pl-6'} mt-4 space-y-2`}>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{rights-li1}', 'Access your personal information')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{rights-li2}', 'Correct inaccurate data')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{rights-li3}', 'Request deletion of your data')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{rights-li4}', 'Object to data processing')}
                    </li>
                    <li className="text-lg leading-relaxed font-thin text-[#000000]" style={liStyle}>
                      {t('{rights-li5}', 'Withdraw consent for analytics cookies')}
                    </li>
                  </ul>
                ...
                <section>
                  ...
                  >
                    {t(
                      '{retention-p1}',
                      'We retain personal information only as long as necessary to fulfill the purposes outlined in this policy or as required by Saudi Arabian law. Analytics data is automatically deleted by Google Analytics after 26 months.'
                    )}
                  </p>
                </section>
                ...
                <section>
                  ...
                  >
                    {t(
                      '{intl-p1}',
                      'Some of our service providers (such as Google Analytics) may process data outside of Saudi Arabia. We ensure that appropriate safeguards are in place to protect your data in accordance with applicable laws.'
                    )}
                  </p>
                </section>
