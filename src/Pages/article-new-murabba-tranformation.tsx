...
export default function Article7() {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      if (!cancelled) {
        if (error) {
          console.error('[Article7] fetch error:', error);
          setTexts({});
        } else {
          const map: TextMap = {};
  ...
  const S2   = t(`${base}-s2`, 'Blending Innovation With Everyday Life');
  const S2P1 = t(`${base}-s2p1`, "What makes New Murabba different is how it brings together different layers of life...");
  const S2P2 = t(`${base}-s2p2`, 'The design is meant to reduce time spent in transit, create more social interaction...');

  const S3   = t(`${base}-s3`, 'A Vision That Reflects a Shift in Priorities');
  ...
  const relatedArticles = [
    {
      id: 'Article1',
      title: t(
        'article-verified-leed-associates-title',
        'Leading the Green Revolution: Our Journey as Verified LEED Associates in Saudi Arabia'
      ),
    ...
    },
    {
      id: 'Article2',
      title: t(
        'article-minimal-elegance-riyadh-title',
        'Minimalist Elegance: The Rise of Contemporary Interior Design in Saudi Homes'
      ),
    ...
    },
    {
      id: 'Article3',
      title: t(
        'article-intergrating-pool-in-landscape-title',
        'Water as a Design Element: How Pools Redefine Spatial Experience'
      ),
    ...
    },
    {
      id: 'Article4',
      title: t(
        'article-downtown-design-riyadh-2025-title',
        "Downtown Design Riyadh 2025: Showcasing Saudi's Creative Pulse"
      ),
    ...
    },
    {
      id: 'Article5',
      title: t(
        'article-al-balad-renaissance-in-jeddah-title',
        "Al-Balad's Renaissance: Preserving Jeddah's Historic Heart"
      ),
    ...
    },
    {
      id: 'Article6',
      title: t(
        'article-red-sea-global-leed-achievements-title',
        "Red Sea Global's LEED Achievements: Setting New Standards in Sustainable Tourism"
      ),
  ...
  return (
    <PageWrapper>
      ...
      <div className={isAr ? 'athar-rtl-article' : undefined}>
        ...
        <ArticleTemplate
          title={Title}
          imageUrl="https://2sdiz6bji6.ufs.sh/f/A7G6PIBqyzTtl9519zj8py3SQgmqvbGXIfLdhR4r9PauEo0O"
          content={
            <>
              <p>{Intro}</p>
